...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    {
    	if(NeighborNode->visited == true) continue;
      	...
      	this->open_list.push_back(NeighborNode);  
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    sort(this->open_list.begin(), this->open_list.end(), &comparator);
	RouteModel::Node * LowestSum_Node;
  	LowestSum_Node = this->open_list.front();
